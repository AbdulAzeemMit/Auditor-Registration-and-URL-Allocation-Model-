                    ...
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function() {
                            ...
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                ...
                                var input = '<input  type="text" class="tabledit-input ' + settings.inputClass + '"  name="' + settings.columns.editable[i][1] + '" value="' + $(this).text() + '" style="display: none;" autocomplete="off"'+' disabled pattern="[A-Za-z]{3}">';
                        //    var input1='<select>'+
                        //    '<option>op1<option>'+
                        //    '<option>op2<option>'+
                        ...
                        //    '</select>';
                            ...
                            // this.find('#heading').append('<th name="buttons"'+'style="background-color:#ff8080">Action</th>');  //encabezado vacío
